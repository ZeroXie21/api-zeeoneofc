...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'https://api-zeroxie21.herokuapp.com/api/ig/stalk?username=zeroxie&apikey=Alphabot') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'https://api-zeroxie21.herokuapp.com/api/ig/stalk?username=zeroxie&apikey=Alphabot') return res.json(loghandler.invalidKey)
